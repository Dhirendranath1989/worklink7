...
import { loginUser, loginWithEmail, loginWithGoogle, clearError } from '../../features/auth/authSlice';
    ...
    <div className="min-h-screen flex bg-white dark:bg-gray-900">
      ...
      <div className="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-20 xl:px-24 bg-white dark:bg-gray-900">
        <div className="mx-auto w-full max-w-sm lg:w-96">
          ...
          <div className="mt-8">
            {/* Google Login - Now prominently placed at the top */}
            <div className="mb-8">
              <button
                type="button"
                onClick={handleGoogleSignIn}
                disabled={isLoading}
                className="w-full inline-flex justify-center items-center py-3 px-4 border-2 border-gray-300 dark:border-gray-600 rounded-lg shadow-sm bg-white dark:bg-gray-800 text-base font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 hover:border-gray-400 dark:hover:border-gray-500 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
              >
                {isLoading ? (
                  <>
            ...
            <div className="relative mb-8">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white dark:bg-gray-900 text-gray-500 dark:text-gray-400 font-medium">Or sign in with email</span>
              </div>
            </div>
              ...
              <div>
                ...
                <div className="mt-1">
                  <input
                    ...
                    className={`input-field ${errors.email ? 'border-red-300 focus:border-red-500 focus:ring-red-500 dark:border-red-600 dark:focus:border-red-400 dark:focus:ring-red-400' : ''}`}
      ...
      <div className="hidden lg:block relative w-0 flex-1">
        ...
        />
        <div className="absolute inset-0 bg-primary-600 mix-blend-multiply opacity-60"></div>
        <div className="absolute inset-0 flex items-center justify-center p-12">
          <div className="text-center text-white">
            ...
            <p className="text-xl opacity-90">
              Connect with local opportunities and grow your business
            </p>
          </div>
        </div>
      </div>
